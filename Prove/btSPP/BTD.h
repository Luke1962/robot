...
http://felis.github.io/USB_Host_Shield_2.0/index.html
 */
// ARDUINO DUE ------
#ifndef NULL
    #define NULL 0
...
protected:
        ...
        USBHost *pUsb;		//WAS USB *pUsb;
        /** Device address. */
        uint8_t bAddress;
        /** Endpoint info structure. */
        UsbDevice epInfo[BTD_MAX_ENDPOINTS];		//WAS  EpInfo epInfo[BTD_MAX_ENDPOINTS];
