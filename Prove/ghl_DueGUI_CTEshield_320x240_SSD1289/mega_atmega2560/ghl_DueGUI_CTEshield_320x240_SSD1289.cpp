...
UTFT myGLCD(ILI9341_S5P, MOSI, SCK, PIN_CS, PIN_RESET, PIN_DC);   // Remember to change the model parameter to suit your display module!
...
void DueGUI_createScreen(int screen){
  ...
  if (DueGUI_currentlyDisplayedScreen==main_menu){
   ...
   DueGUI.addGhostButton(0,0,319,40,0,optVisible,URNghostbutton);
  		DueGUI.db_St(2, "add addGhostButton");
  ...
  DueGUI.restartTimer(DueGUI_timer);
  		DueGUI.db_St(2, "restartTimer done");
...
void setup(){ 
	...
	myGLCD.setColor(0, 0, 64);
	myGLCD.fillRect(0, 226, 319, 239);
	myGLCD.setColor(255, 255, 255);
	myGLCD.setBackColor(255, 0, 0);
	myGLCD.print("* UTFT  Library *", CENTER, 1);
	delay(2000);
  ...
  //void DUEGUI::InitGUI( Unused,  Unused,  Unused,  Unused,  Unused, int CS_pin, int Rate, Unused){
  DueGUI.db_St(1, " 423 ");

    DueGUI.InitGUI(0, 0, 0, 0, 0, PIN_CS,2,0);   //DueGUI.InitGUI(6,5,32,3,2,52,2,51);
