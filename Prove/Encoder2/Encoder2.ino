...
#define c_LeftEncoderPinA Pin_EncLa //19 
#define c_LeftEncoderPinB Pin_EncLb //25
...
#define c_RightEncoderPinA	Pin_EncRa	// 18
#define c_RightEncoderPinB	Pin_EncRb	// 24
...
int potpin =Pin_AnaPot1-Pin_AnaBase;  //0 analog pin used to connect the potentiometer
...
void setup()
{
  ...
  _RightServo.attach(Pin_ServoSonarPWM);  // 2attaches the servo on specified pin to the servo object
