...
int main(int argc, char **argv) {
	...
	ros::init(argc, argv, "lizi_node", ros::init_options::AnonymousName);
	...
	ros::Subscriber raw_sub = n.subscribe(lizi_raw_topic, 10, rawCallback);
	ros::Subscriber gps_sub = n.subscribe(lizi_gps_topic, 10, gpsCallback);
	...
	command_pub = n.advertise < lizi::lizi_command > (lizi_command_topic, 5);
