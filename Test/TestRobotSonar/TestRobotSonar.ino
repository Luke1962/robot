...
#define SCANSPEED 90	//OK 60	// considera 3ms al metro , con max_distance 2m, e 5 impulsi per posizione ci vogliono 3*2*5=30ms
#define StepAngle 30 //OK 10 //ampiezza step in gradi della scansione
#define SCANANGLE 180
NewPing sonar(TRIGGER_PIN, ECHO_PIN, MAX_DISTANCE); // NewPing setup of pins and maximum distance.
Servo myservo;

//#define myservo robot.pServoSonar->
int ping_delay = 50;
...
void loop()
{
	...
	{                                  // in steps of n degrees 
		robot.pServoSonar->write(pos);              // tell servo to go to position in variable 'pos'     
