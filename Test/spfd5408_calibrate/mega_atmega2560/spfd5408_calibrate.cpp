...
// Calibrates value
#define SENSIBILITY 300	//was 300  ohms across the X plate
#define MINPRESSURE 0	//was 10
...
void setup(void) {
 ...
 Serial.begin(9600);
 Serial.println("\tTouch Screen Calbration ");
...
TSPoint waitOneTouch() {
   ...
   do {
	...
	p.y = ts.readTouchY();
	p.z = ts.pressure();
Serial.print("\n waitOneTouch tp.z = "); Serial.println(p.z);
